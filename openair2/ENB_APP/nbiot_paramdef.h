...
{"nprach_Periodicity",                                         NULL,   0,              uptr:NULL,                                    defintval:640,	    TYPE_UINT,       0},  \
{"nprach_StartTime",                                           NULL,   0,              uptr:NULL,                                    defintval:8,	    TYPE_UINT,       0},  \
{"nprach_SubcarrierOffset",                                    NULL,   0,              uptr:NULL,                                    defintval:36,	    TYPE_UINT,       0},  \
{"nprach_NumSubcarriers",                                      NULL,   0,              uptr:NULL,                                    defintval:12,	    TYPE_UINT,       0},  \
{"nprach_SubcarrierMSG3_RangeStart",                           NULL,   0,              strptr:NULL,                                  defstrval:"on",	    TYPE_STRING,     0},  \
{"maxNumPreambleAttemptCE_NB",                                 NULL,   0,              uptr:NULL,                                    defintval:10,	    TYPE_UINT,       0},  \
{"numRepetitionsPerPreambleAttempt_NB",                        NULL,   0,              uptr:NULL,                                    defintval:4,	    TYPE_UINT,       0},  \
