			     ...
			     )
{
  ...
  nfapi_config_request_t *cfg = &RC.nb_iot_mac[Mod_idP]->config;
    ...
    case 1:
      ...
      extra_phy_parms.nprach_config_0_npdcch_num_repetitions_RA = nprach_parameter->npdcch_NumRepetitions_RA_r13; //Rmax
    ...
    uint8_t                                 ue_list_ded_num)
{
    ...
    if(sib1_NB_IoT != NULL)
    {
        ...
        //set this value for now to be test further
