...
dtm_r9_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	dtm_r9_2_inherit_TYPE_descriptor(td1);
	dtm_r9_2_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
e_RedirectionGERAN_r9_4_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	e_RedirectionGERAN_r9_4_inherit_TYPE_descriptor(td1);
	e_RedirectionGERAN_r9_4_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
asn_TYPE_descriptor_t asn_DEF_e_RedirectionGERAN_r9_4 = {
	...
	e_RedirectionGERAN_r9_4_compare,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_IRAT_ParametersGERAN_v920_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dtm-r9 at 9498 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* e-RedirectionGERAN-r9 at 9499 */
};
