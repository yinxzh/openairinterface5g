...
transmissionMode_r10_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	transmissionMode_r10_2_inherit_TYPE_descriptor(td1);
	transmissionMode_r10_2_inherit_TYPE_descriptor(td2);
...
asn_TYPE_descriptor_t asn_DEF_transmissionMode_r10_2 = {
	...
	transmissionMode_r10_2_compare,
