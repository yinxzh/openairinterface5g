...
subframeAssignment_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	subframeAssignment_2_inherit_TYPE_descriptor(td1);
	subframeAssignment_2_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
specialSubframePatterns_10_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	specialSubframePatterns_10_inherit_TYPE_descriptor(td1);
	specialSubframePatterns_10_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
asn_TYPE_descriptor_t asn_DEF_specialSubframePatterns_10 = {
	...
	specialSubframePatterns_10_compare,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_TDD_Config_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* subframeAssignment at 6564 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* specialSubframePatterns at 6566 */
};
