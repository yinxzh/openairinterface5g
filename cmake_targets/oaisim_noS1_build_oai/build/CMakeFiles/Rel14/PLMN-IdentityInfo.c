...
cellReservedForOperatorUse_3_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	cellReservedForOperatorUse_3_inherit_TYPE_descriptor(td1);
	cellReservedForOperatorUse_3_inherit_TYPE_descriptor(td2);
...
asn_TYPE_descriptor_t asn_DEF_cellReservedForOperatorUse_3 = {
	...
	cellReservedForOperatorUse_3_compare,
...
static asn_TYPE_tag2member_t asn_MAP_PLMN_IdentityInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-Identity at 2018 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cellReservedForOperatorUse at 2019 */
};
