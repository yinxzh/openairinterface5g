...
measQuantityUTRA_FDD_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	measQuantityUTRA_FDD_2_inherit_TYPE_descriptor(td1);
	measQuantityUTRA_FDD_2_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
measQuantityUTRA_TDD_5_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	measQuantityUTRA_TDD_5_inherit_TYPE_descriptor(td1);
	measQuantityUTRA_TDD_5_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
asn_TYPE_descriptor_t asn_DEF_measQuantityUTRA_FDD_2 = {
	...
	measQuantityUTRA_FDD_2_compare,
...
asn_TYPE_descriptor_t asn_DEF_measQuantityUTRA_TDD_5 = {
	...
	measQuantityUTRA_TDD_5_compare,
	0,	/* Use generic outmost tag fetcher */
