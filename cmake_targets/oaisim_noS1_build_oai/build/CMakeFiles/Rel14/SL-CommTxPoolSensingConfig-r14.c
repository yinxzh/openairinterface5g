...
static asn_enc_rval_t
sl_ReselectAfter_r14_17_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	sl_ReselectAfter_r14_17_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_comp_rval_t * 
sl_ReselectAfter_r14_17_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	sl_ReselectAfter_r14_17_inherit_TYPE_descriptor(td1);
	sl_ReselectAfter_r14_17_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
sl_ReselectAfter_r14_17_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	sl_ReselectAfter_r14_17_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_TYPE_tag2member_t asn_MAP_p2x_SensingConfig_r14_tag2el_14[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* minNumCandidateSF-r14 at 10282 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* gapCandidateSensing-r14 at 10283 */
};
...
asn_TYPE_descriptor_t asn_DEF_sl_ReselectAfter_r14_17 = {
	...
	sl_ReselectAfter_r14_17_decode_aper,
	sl_ReselectAfter_r14_17_encode_aper,
	sl_ReselectAfter_r14_17_compare,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_SL_CommTxPoolSensingConfig_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pssch-TxConfigList-r14 at 10276 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* thresPSSCH-RSRP-List-r14 at 10277 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* restrictResourceReservationPeriod-r14 at 10278 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* probResourceKeep-r14 at 10279 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* p2x-SensingConfig-r14 at 10282 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* sl-ReselectAfter-r14 at 10285 */
};
