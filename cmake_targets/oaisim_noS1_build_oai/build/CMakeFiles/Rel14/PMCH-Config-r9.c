...
mch_SchedulingPeriod_r9_4_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	mch_SchedulingPeriod_r9_4_inherit_TYPE_descriptor(td1);
	mch_SchedulingPeriod_r9_4_inherit_TYPE_descriptor(td2);
...
asn_TYPE_descriptor_t asn_DEF_mch_SchedulingPeriod_r9_4 = {
	...
	mch_SchedulingPeriod_r9_4_compare,
...
static asn_TYPE_tag2member_t asn_MAP_PMCH_Config_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sf-AllocEnd-r9 at 9967 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dataMCS-r9 at 9968 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* mch-SchedulingPeriod-r9 at 9970 */
};
