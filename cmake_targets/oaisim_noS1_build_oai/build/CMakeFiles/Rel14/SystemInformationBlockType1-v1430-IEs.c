...
static asn_enc_rval_t
eCallOverIMS_Support_r14_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	eCallOverIMS_Support_r14_2_inherit_TYPE_descriptor(td);
...
eCallOverIMS_Support_r14_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	eCallOverIMS_Support_r14_2_inherit_TYPE_descriptor(td1);
	eCallOverIMS_Support_r14_2_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
eCallOverIMS_Support_r14_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	eCallOverIMS_Support_r14_2_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_eCallOverIMS_Support_r14_2 = {
	...
	eCallOverIMS_Support_r14_2_decode_aper,
	eCallOverIMS_Support_r14_2_encode_aper,
	eCallOverIMS_Support_r14_2_compare,
...
static asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType1_v1430_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eCallOverIMS-Support-r14 at 2008 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tdd-Config-v1430 at 2009 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* cellAccessRelatedInfoList-r14 at 2011 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* nonCriticalExtension at 2012 */
};
