...
static asn_enc_rval_t
qcl_Operation_3_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	qcl_Operation_3_inherit_TYPE_descriptor(td);
...
qcl_Operation_3_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	qcl_Operation_3_inherit_TYPE_descriptor(td1);
	qcl_Operation_3_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
qcl_Operation_3_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	qcl_Operation_3_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_qcl_Operation_3 = {
	...
	qcl_Operation_3_decode_aper,
	qcl_Operation_3_encode_aper,
	qcl_Operation_3_compare,
