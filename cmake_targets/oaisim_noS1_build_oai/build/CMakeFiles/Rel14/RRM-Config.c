...
ue_InactiveTime_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	ue_InactiveTime_2_inherit_TYPE_descriptor(td1);
	ue_InactiveTime_2_inherit_TYPE_descriptor(td2);
...
static int asn_MAP_ext1_oms_68[] = { 0 };
static ber_tlv_tag_t asn_DEF_ext1_tags_68[] = {
