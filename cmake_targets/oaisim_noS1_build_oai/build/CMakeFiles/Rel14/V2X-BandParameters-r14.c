...
static asn_TYPE_tag2member_t asn_MAP_V2X_BandParameters_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* v2x-FreqBandEUTRA-r14 at 9257 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* bandParametersTxSL-r14 at 9258 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* bandParametersRxSL-r14 at 9259 */
};
