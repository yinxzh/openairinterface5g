...
measQuantityCDMA2000_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	measQuantityCDMA2000_2_inherit_TYPE_descriptor(td1);
	measQuantityCDMA2000_2_inherit_TYPE_descriptor(td2);
...
asn_TYPE_descriptor_t asn_DEF_measQuantityCDMA2000_2 = {
	...
	measQuantityCDMA2000_2_compare,
...
static asn_TYPE_tag2member_t asn_MAP_QuantityConfigCDMA2000_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* measQuantityCDMA2000 at 7912 */
};
