...
ce_ModeA_r13_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	ce_ModeA_r13_2_inherit_TYPE_descriptor(td1);
	ce_ModeA_r13_2_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
ce_ModeB_r13_4_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	ce_ModeB_r13_4_inherit_TYPE_descriptor(td1);
	ce_ModeB_r13_4_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
static asn_TYPE_tag2member_t asn_MAP_CE_Parameters_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ce-ModeA-r13 at 9624 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ce-ModeB-r13 at 9625 */
};
