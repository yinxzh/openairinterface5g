...
ue_ConfigRelease_r9_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	ue_ConfigRelease_r9_2_inherit_TYPE_descriptor(td1);
	ue_ConfigRelease_r9_2_inherit_TYPE_descriptor(td2);
