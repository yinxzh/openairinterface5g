...
static asn_TYPE_tag2member_t asn_MAP_MeasResultCBR_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* poolIdentity-r14 at 7826 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* cbr-PSSCH-r14 at 7827 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* cbr-PSCCH-r14 at 7828 */
};
