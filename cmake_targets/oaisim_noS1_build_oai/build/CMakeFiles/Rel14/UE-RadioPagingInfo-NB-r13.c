...
static asn_enc_rval_t
ue_Category_NB_r13_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	ue_Category_NB_r13_2_inherit_TYPE_descriptor(td);
...
ue_Category_NB_r13_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	ue_Category_NB_r13_2_inherit_TYPE_descriptor(td1);
	ue_Category_NB_r13_2_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
ue_Category_NB_r13_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	ue_Category_NB_r13_2_inherit_TYPE_descriptor(td);
...
static int
multiCarrierPaging_r14_6_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
multiCarrierPaging_r14_6_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
	td->der_encoder    = asn_DEF_NativeEnumerated.der_encoder;
...
static void
multiCarrierPaging_r14_6_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
multiCarrierPaging_r14_6_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
multiCarrierPaging_r14_6_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
multiCarrierPaging_r14_6_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
multiCarrierPaging_r14_6_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
multiCarrierPaging_r14_6_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
multiCarrierPaging_r14_6_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
multiCarrierPaging_r14_6_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_enc_rval_t
multiCarrierPaging_r14_6_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_comp_rval_t * 
multiCarrierPaging_r14_6_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td1);
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
multiCarrierPaging_r14_6_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	multiCarrierPaging_r14_6_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_per_constraints_t asn_PER_type_multiCarrierPaging_r14_constr_6 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_ue_Category_NB_r13_2 = {
	...
	ue_Category_NB_r13_2_decode_aper,
	ue_Category_NB_r13_2_encode_aper,
	ue_Category_NB_r13_2_compare,
...
static asn_INTEGER_enum_map_t asn_MAP_multiCarrierPaging_r14_value2enum_6[] = {
	{ 0,	4,	"true" }
};
static unsigned int asn_MAP_multiCarrierPaging_r14_enum2value_6[] = {
	0	/* true(0) */
};
static asn_INTEGER_specifics_t asn_SPC_multiCarrierPaging_r14_specs_6 = {
...
static ber_tlv_tag_t asn_DEF_multiCarrierPaging_r14_tags_6[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_multiCarrierPaging_r14_6 = {
	...
	"multiCarrierPaging-r14",
	multiCarrierPaging_r14_6_free,
	multiCarrierPaging_r14_6_print,
	multiCarrierPaging_r14_6_constraint,
	multiCarrierPaging_r14_6_decode_ber,
	multiCarrierPaging_r14_6_encode_der,
	multiCarrierPaging_r14_6_decode_xer,
	multiCarrierPaging_r14_6_encode_xer,
	multiCarrierPaging_r14_6_decode_uper,
	multiCarrierPaging_r14_6_encode_uper,
	multiCarrierPaging_r14_6_decode_aper,
	multiCarrierPaging_r14_6_encode_aper,
	multiCarrierPaging_r14_6_compare,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* multiCarrierPaging-r14 at 12619 */
};
...
static asn_TYPE_tag2member_t asn_MAP_UE_RadioPagingInfo_NB_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-Category-NB-r13 at 12617 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ext1 at 12619 */
};
