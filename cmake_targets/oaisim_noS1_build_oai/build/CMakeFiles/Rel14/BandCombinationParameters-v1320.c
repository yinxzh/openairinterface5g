...
static asn_enc_rval_t
additionalRx_Tx_PerformanceReq_r13_4_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	additionalRx_Tx_PerformanceReq_r13_4_inherit_TYPE_descriptor(td);
...
additionalRx_Tx_PerformanceReq_r13_4_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	additionalRx_Tx_PerformanceReq_r13_4_inherit_TYPE_descriptor(td1);
	additionalRx_Tx_PerformanceReq_r13_4_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
additionalRx_Tx_PerformanceReq_r13_4_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	additionalRx_Tx_PerformanceReq_r13_4_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_additionalRx_Tx_PerformanceReq_r13_4 = {
	...
	additionalRx_Tx_PerformanceReq_r13_4_decode_aper,
	additionalRx_Tx_PerformanceReq_r13_4_encode_aper,
	additionalRx_Tx_PerformanceReq_r13_4_compare,
	0,	/* Use generic outmost tag fetcher */
