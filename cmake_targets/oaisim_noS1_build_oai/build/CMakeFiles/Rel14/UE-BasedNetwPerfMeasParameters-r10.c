...
loggedMeasurementsIdle_r10_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	loggedMeasurementsIdle_r10_2_inherit_TYPE_descriptor(td1);
	loggedMeasurementsIdle_r10_2_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
standaloneGNSS_Location_r10_4_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	standaloneGNSS_Location_r10_4_inherit_TYPE_descriptor(td1);
	standaloneGNSS_Location_r10_4_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
asn_TYPE_descriptor_t asn_DEF_loggedMeasurementsIdle_r10_2 = {
	...
	loggedMeasurementsIdle_r10_2_compare,
...
asn_TYPE_descriptor_t asn_DEF_standaloneGNSS_Location_r10_4 = {
	...
	standaloneGNSS_Location_r10_4_compare,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_UE_BasedNetwPerfMeasParameters_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* loggedMeasurementsIdle-r10 at 9559 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* standaloneGNSS-Location-r10 at 9560 */
};
