...
static asn_TYPE_tag2member_t asn_MAP_UplinkPowerControlCommonPUSCH_LessCell_v1430_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* p0-Nominal-PeriodicSRS-r14 at 6684 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* p0-Nominal-AperiodicSRS-r14 at 6685 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* alpha-SRS-r14 at 6686 */
};
