...
static asn_enc_rval_t
powerRampingStep_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	powerRampingStep_2_inherit_TYPE_descriptor(td);
...
powerRampingStep_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	powerRampingStep_2_inherit_TYPE_descriptor(td1);
	powerRampingStep_2_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
powerRampingStep_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	powerRampingStep_2_inherit_TYPE_descriptor(td);
...
static asn_enc_rval_t
preambleInitialReceivedTargetPower_7_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	preambleInitialReceivedTargetPower_7_inherit_TYPE_descriptor(td);
	return td->aper_encoder(td, constraints, structure, per_out);
...
static asn_comp_rval_t * 
preambleInitialReceivedTargetPower_7_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	preambleInitialReceivedTargetPower_7_inherit_TYPE_descriptor(td1);
	preambleInitialReceivedTargetPower_7_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
preambleInitialReceivedTargetPower_7_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	preambleInitialReceivedTargetPower_7_inherit_TYPE_descriptor(td);
	return td->aper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
asn_TYPE_descriptor_t asn_DEF_powerRampingStep_2 = {
	...
	powerRampingStep_2_decode_aper,
	powerRampingStep_2_encode_aper,
	powerRampingStep_2_compare,
...
asn_TYPE_descriptor_t asn_DEF_preambleInitialReceivedTargetPower_7 = {
	...
	preambleInitialReceivedTargetPower_7_decode_aper,
	preambleInitialReceivedTargetPower_7_encode_aper,
	preambleInitialReceivedTargetPower_7_compare,
	0,	/* Use generic outmost tag fetcher */
...
static asn_TYPE_tag2member_t asn_MAP_PowerRampingParameters_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* powerRampingStep at 5657 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* preambleInitialReceivedTargetPower at 5659 */
};
