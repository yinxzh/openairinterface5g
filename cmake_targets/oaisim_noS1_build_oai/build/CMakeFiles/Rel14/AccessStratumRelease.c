...
asn_comp_rval_t * 
AccessStratumRelease_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	AccessStratumRelease_1_inherit_TYPE_descriptor(td1);
	AccessStratumRelease_1_inherit_TYPE_descriptor(td2);
