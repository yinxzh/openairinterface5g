...
static asn_enc_rval_t
reducedMeasPerformance_r12_8_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	reducedMeasPerformance_r12_8_inherit_TYPE_descriptor(td);
...
reducedMeasPerformance_r12_8_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	reducedMeasPerformance_r12_8_inherit_TYPE_descriptor(td1);
	reducedMeasPerformance_r12_8_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
reducedMeasPerformance_r12_8_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	reducedMeasPerformance_r12_8_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_reducedMeasPerformance_r12_8 = {
	...
	reducedMeasPerformance_r12_8_decode_aper,
	reducedMeasPerformance_r12_8_encode_aper,
	reducedMeasPerformance_r12_8_compare,
...
static asn_TYPE_tag2member_t asn_MAP_CarrierFreqUTRA_TDD_r12_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* carrierFreq-r12 at 3086 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* cellReselectionPriority-r12 at 3087 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* threshX-High-r12 at 3088 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* threshX-Low-r12 at 3089 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* q-RxLevMin-r12 at 3090 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* p-MaxUTRA-r12 at 3091 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* reducedMeasPerformance-r12 at 3092 */
};
