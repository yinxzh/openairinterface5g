...
repetitionFactor_5_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	repetitionFactor_5_inherit_TYPE_descriptor(td1);
	repetitionFactor_5_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
tdd_AckNackFeedbackMode_11_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	tdd_AckNackFeedbackMode_11_inherit_TYPE_descriptor(td1);
	tdd_AckNackFeedbackMode_11_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
asn_TYPE_descriptor_t asn_DEF_tdd_AckNackFeedbackMode_11 = {
	...
	tdd_AckNackFeedbackMode_11_compare,
	0,	/* Use generic outmost tag fetcher */
