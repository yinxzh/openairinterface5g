...
static asn_enc_rval_t
simultaneousAckNackAndCQI_Format4_Format5_r13_3_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	simultaneousAckNackAndCQI_Format4_Format5_r13_3_inherit_TYPE_descriptor(td);
...
simultaneousAckNackAndCQI_Format4_Format5_r13_3_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	simultaneousAckNackAndCQI_Format4_Format5_r13_3_inherit_TYPE_descriptor(td1);
	simultaneousAckNackAndCQI_Format4_Format5_r13_3_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
simultaneousAckNackAndCQI_Format4_Format5_r13_3_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	simultaneousAckNackAndCQI_Format4_Format5_r13_3_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_simultaneousAckNackAndCQI_Format4_Format5_r13_3 = {
	...
	simultaneousAckNackAndCQI_Format4_Format5_r13_3_decode_aper,
	simultaneousAckNackAndCQI_Format4_Format5_r13_3_encode_aper,
	simultaneousAckNackAndCQI_Format4_Format5_r13_3_compare,
...
static asn_TYPE_tag2member_t asn_MAP_CQI_ReportPeriodic_v1310_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cri-ReportConfig-r13 at 3785 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* simultaneousAckNackAndCQI-Format4-Format5-r13 at 3786 */
};
