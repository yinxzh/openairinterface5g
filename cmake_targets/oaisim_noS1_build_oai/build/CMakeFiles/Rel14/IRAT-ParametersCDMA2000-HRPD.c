...
tx_ConfigHRPD_3_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	tx_ConfigHRPD_3_inherit_TYPE_descriptor(td1);
	tx_ConfigHRPD_3_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
rx_ConfigHRPD_6_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	rx_ConfigHRPD_6_inherit_TYPE_descriptor(td1);
	rx_ConfigHRPD_6_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
static asn_TYPE_tag2member_t asn_MAP_IRAT_ParametersCDMA2000_HRPD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportedBandListHRPD at 9510 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tx-ConfigHRPD at 9511 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* rx-ConfigHRPD at 9512 */
};
