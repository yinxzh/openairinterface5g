...
t320_8_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	t320_8_inherit_TYPE_descriptor(td1);
	t320_8_inherit_TYPE_descriptor(td2);
...
static int asn_MAP_IdleModeMobilityControlInfo_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
