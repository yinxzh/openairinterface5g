...
static asn_enc_rval_t
pdcp_SN_Extension_18bits_r13_2_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	pdcp_SN_Extension_18bits_r13_2_inherit_TYPE_descriptor(td);
...
pdcp_SN_Extension_18bits_r13_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	pdcp_SN_Extension_18bits_r13_2_inherit_TYPE_descriptor(td1);
	pdcp_SN_Extension_18bits_r13_2_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
pdcp_SN_Extension_18bits_r13_2_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	pdcp_SN_Extension_18bits_r13_2_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_pdcp_SN_Extension_18bits_r13_2 = {
	...
	pdcp_SN_Extension_18bits_r13_2_decode_aper,
	pdcp_SN_Extension_18bits_r13_2_encode_aper,
	pdcp_SN_Extension_18bits_r13_2_compare,
...
static asn_TYPE_tag2member_t asn_MAP_PDCP_Parameters_v1310_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* pdcp-SN-Extension-18bits-r13 at 8791 */
};
