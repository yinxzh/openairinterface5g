...
csg_MemberStatus_r9_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	csg_MemberStatus_r9_2_inherit_TYPE_descriptor(td1);
	csg_MemberStatus_r9_2_inherit_TYPE_descriptor(td2);
...
static asn_TYPE_tag2member_t asn_MAP_AdditionalSI_Info_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* csg-MemberStatus-r9 at 7839 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* csg-Identity-r9 at 7840 */
};
