...
antennaPortsCount_r10_5_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	antennaPortsCount_r10_5_inherit_TYPE_descriptor(td1);
	antennaPortsCount_r10_5_inherit_TYPE_descriptor(td2);
...
asn_TYPE_descriptor_t asn_DEF_antennaPortsCount_r10_5 = {
	...
	antennaPortsCount_r10_5_compare,
