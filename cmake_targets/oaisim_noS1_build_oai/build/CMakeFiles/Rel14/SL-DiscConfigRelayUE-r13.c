...
hystMax_r13_4_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	hystMax_r13_4_inherit_TYPE_descriptor(td1);
	hystMax_r13_4_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
hystMin_r13_11_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	hystMin_r13_11_inherit_TYPE_descriptor(td1);
	hystMin_r13_11_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
