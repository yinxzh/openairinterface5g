...
static asn_enc_rval_t
cdmType_r13_6_encode_aper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	cdmType_r13_6_inherit_TYPE_descriptor(td);
...
cdmType_r13_6_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	cdmType_r13_6_inherit_TYPE_descriptor(td1);
	cdmType_r13_6_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}

static asn_dec_rval_t
cdmType_r13_6_decode_aper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	cdmType_r13_6_inherit_TYPE_descriptor(td);
...
asn_TYPE_descriptor_t asn_DEF_cdmType_r13_6 = {
	...
	cdmType_r13_6_decode_aper,
	cdmType_r13_6_encode_aper,
	cdmType_r13_6_compare,
	0,	/* Use generic outmost tag fetcher */
