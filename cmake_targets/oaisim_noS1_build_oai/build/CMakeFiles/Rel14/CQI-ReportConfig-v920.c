...
cqi_Mask_r9_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	cqi_Mask_r9_2_inherit_TYPE_descriptor(td1);
	cqi_Mask_r9_2_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
pmi_RI_Report_r9_4_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	pmi_RI_Report_r9_4_inherit_TYPE_descriptor(td1);
	pmi_RI_Report_r9_4_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
static asn_TYPE_tag2member_t asn_MAP_CQI_ReportConfig_v920_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cqi-Mask-r9 at 3675 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* pmi-RI-Report-r9 at 3676 */
};
