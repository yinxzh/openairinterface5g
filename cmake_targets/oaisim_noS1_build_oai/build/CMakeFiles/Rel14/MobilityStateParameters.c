...
t_Evaluation_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	t_Evaluation_2_inherit_TYPE_descriptor(td1);
	t_Evaluation_2_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
t_HystNormal_11_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	t_HystNormal_11_inherit_TYPE_descriptor(td1);
	t_HystNormal_11_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
