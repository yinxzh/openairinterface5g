...
srs_BandwidthConfig_4_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	srs_BandwidthConfig_4_inherit_TYPE_descriptor(td1);
	srs_BandwidthConfig_4_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
srs_SubframeConfig_13_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	srs_SubframeConfig_13_inherit_TYPE_descriptor(td1);
	srs_SubframeConfig_13_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
static asn_comp_rval_t * 
srs_MaxUpPts_31_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	srs_MaxUpPts_31_inherit_TYPE_descriptor(td1);
	srs_MaxUpPts_31_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
static asn_TYPE_tag2member_t asn_MAP_setup_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* srs-BandwidthConfig at 6321 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* srs-SubframeConfig at 6323 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* ackNackSRS-SimultaneousTransmission at 6325 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* srs-MaxUpPts at 6326 */
};
...
static asn_TYPE_tag2member_t asn_MAP_SoundingRS_UL_ConfigCommon_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release at 6319 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup at 6321 */
};
