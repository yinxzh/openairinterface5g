...
antennaPortsCount_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	antennaPortsCount_2_inherit_TYPE_descriptor(td1);
	antennaPortsCount_2_inherit_TYPE_descriptor(td2);
...
static asn_TYPE_tag2member_t asn_MAP_AntennaInfoCommon_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* antennaPortsCount at 3606 */
};
