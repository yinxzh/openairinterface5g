...
gummei_Type_r10_2_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	gummei_Type_r10_2_inherit_TYPE_descriptor(td1);
	gummei_Type_r10_2_inherit_TYPE_descriptor(td2);
...
static asn_comp_rval_t * 
rlf_InfoAvailable_r10_5_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	rlf_InfoAvailable_r10_5_inherit_TYPE_descriptor(td1);
	rlf_InfoAvailable_r10_5_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
static asn_comp_rval_t * 
logMeasAvailable_r10_7_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	logMeasAvailable_r10_7_inherit_TYPE_descriptor(td1);
	logMeasAvailable_r10_7_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
static asn_comp_rval_t * 
rn_SubframeConfigReq_r10_9_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	rn_SubframeConfigReq_r10_9_inherit_TYPE_descriptor(td1);
	rn_SubframeConfigReq_r10_9_inherit_TYPE_descriptor(td2);
	res = td1->compare(td1, structure1, td2, structure2);
	return res;
}
...
asn_TYPE_descriptor_t asn_DEF_rlf_InfoAvailable_r10_5 = {
	...
	rlf_InfoAvailable_r10_5_compare,
	0,	/* Use generic outmost tag fetcher */
...
asn_TYPE_descriptor_t asn_DEF_logMeasAvailable_r10_7 = {
	...
	logMeasAvailable_r10_7_compare,
	0,	/* Use generic outmost tag fetcher */
...
asn_TYPE_descriptor_t asn_DEF_rn_SubframeConfigReq_r10_9 = {
	...
	rn_SubframeConfigReq_r10_9_compare,
	0,	/* Use generic outmost tag fetcher */
