...
static asn_TYPE_tag2member_t asn_MAP_PCCH_Config_v1310_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* paging-narrowBands-r13 at 5862 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* mpdcch-NumRepetition-Paging-r13 at 5863 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nB-v1310 at 5864 */
};
